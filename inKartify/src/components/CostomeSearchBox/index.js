...
const CostomeSearch = props => {
    const {filter, placeholder, mike=true, onChangeText={}} = {...props} // the filter willbe true when the order screen render.
            ...
            <View style={filter? [responsiveStyle.newSearch] : [responsiveStyle.search]}>
                <View style={responsiveStyle.innerSearch}>
                    ...
                    <TextInput
                        ...
                        selectionColor={color.EmeraldGreen}
                        placeholderTextColor={color.black_level_3}
